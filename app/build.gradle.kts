...
android {
    namespace = "com.example.helpquest"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.helpquest"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
   ...
   // implementation(libs.maps.compose)
    ...
    implementation(libs.androidx.material.icons.extended)  // O la última versión estable de Compose
